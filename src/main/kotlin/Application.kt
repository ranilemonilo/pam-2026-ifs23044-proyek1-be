...
fun main(args: Array<String>) {
    // Load .env SEBELUM Ktor baca application.yaml
    val dotenv = dotenv {
        directory = "."
        ignoreIfMissing = true  // agar tidak crash saat deploy di server yang pakai env asli
    }
    dotenv.entries().forEach { entry ->
        // Hanya set jika belum ada di system environment (agar env server tidak tertimpa)
